                            ...
                            ({ plan, tagline, quota, features }) => {
                                ...
                                return (
                                    <div
                                        ...
                                        {/* add this in below div if needed -->> rounded-br-2xl rounded-bl-2xl */}
                                        <div className='flex h-20 items-center justify-center border-b border-t border-gray-200 bg-gray-50 border-r'>
